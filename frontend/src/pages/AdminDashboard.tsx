        ...
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-14 sm:h-16">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="min-w-0">
              ...
              <span className="ml-2 text-xs bg-white/20 px-2 py-0.5 rounded-full hidden sm:inline">Administrador</span>
            </div>
          </div>
          <div className="flex items-center gap-2 sm:gap-4">
            <span className="text-sm text-blue-200 hidden md:block truncate max-w-[160px]">{user?.name}</span>
            <button onClick={logout} className="text-xs bg-white/10 hover:bg-white/20 px-3 py-1.5 rounded-lg transition-colors whitespace-nowrap">
              Sair
            </button>
          </div>
        </div>
                ...
                <tbody>
                  {students.map((s) => (
                    <tr key={s.id} className="hover:bg-slate-50">
                      ...
                      <td className="table-td">
                        <span className="bg-blue-50 text-blue-700 text-xs font-semibold px-2 py-0.5 rounded whitespace-nowrap">
                          {s.semester}º
                        </span>
                      </td>
                      <td className="table-td">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        {selectedStudent && (
          <div className="self-end">
            <span className="bg-blue-50 text-blue-700 text-xs font-semibold px-3 py-2 rounded-lg block sm:inline">
            ...
            {enrollments.map((e) => {
              ...
              return (
                <div key={e.enrollment_id}
                  className={`border rounded-xl p-4 ${isEditing ? 'border-blue-300 bg-blue-50/30' : 'border-slate-200 bg-white'}`}>
                  ...
                  {isEditing ? (
                    ...
                    <>
                      ...
                      <button className="w-full bg-blue-50 hover:bg-blue-100 text-blue-700 py-2 rounded-lg text-sm font-medium"
            ...
            <table className="w-full">
              ...
              <tbody>
                {enrollments.map((e) => {
                  ...
                  return (
                    <tr key={e.enrollment_id} className={`hover:bg-slate-50 ${isEditing ? 'bg-blue-50/40' : ''}`}>
                      <td className="table-td">
                      ...
                      <td className="table-td text-center">
                        {isEditing ? (
                          ...
                          <button className="bg-blue-50 hover:bg-blue-100 text-blue-700 px-3 py-1 rounded-lg text-xs font-medium"
                            onClick={() => startEdit(e)}>Editar</button>
                        )}
                      </td>
                    </tr>
